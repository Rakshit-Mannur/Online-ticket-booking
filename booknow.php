                ...
                <div class="resp-tabs-container">
                    <div class="tab-1 resp-tab-content roundtrip">
                        <form action="confirm.php" method="post">
                            ...
                            <div class="to">
                                <h4>To</h4>
                                <select id="w3_country1" onchange="change_country(this.value)" class="frm-field required" name="to">
									<option value="null">Bagalkot</option>  
									<option value="null">Bangalore</option>   
									<option value="null">Mysore</option>   
									<option value="null">Bijapur</option>   		
                            ...
                            <div class="date">
                                ...
                                <div class="return">
                                    <h4>Return</h4>
                                    <input id="datepicker1" name="rtime" type="text" value="mm/dd/yyyy" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'mm/dd/yyyy';}" required="">
                                </div>
                                <div class="clear"></div>
                            </div>
                            <div class="class">
